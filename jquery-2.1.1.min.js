(function() {
    ...
    const topBarHtml = `
        <div class="network-inner">
            ...
            <div class="network-links">
                ...
                <a href="https://biolyze70.space" target="_blank" title="patpat" class="net-btn purple">
                    <span>💎</span> Biolyze 70
                </a>
                
                <a href="https://biolyze80.space" target="_blank" title="ahoy" class="net-btn">
                    <span>⚽</span> Biolyze 80
                </a>

                <a href="https://biolyze90.space" target="_blank" title="ahoy" class="net-btn orange">
                    <span>🎬</span> Biolyze 90
                </a>
                <a href="https://biolyze100.space" target="_blank" title="patpat" class="net-btn purple">
                    <span>💎</span> Biolyze 100
                </a>            
            </div>
    ...
    function injectNetworkBar() {
        ...
        floatingBtnWrapper.innerHTML = `
            ...
            <a id="floating-agarlive-btn" href="https://glipglops.space/" target="_blank">
                <span>⚔️</span> Snake.io
            </a>
        `;
