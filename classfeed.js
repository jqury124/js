(function() {
    ...
    const styles = `
        ...
        #edu-stream-open-btn {
            ...
            display: none; /* İlk başta gizli, chat açıkken görünmez */
            align-items: center;
            gap: 8px;
        }
    ...
    function initSystem() {
        ...
        closeBtn.addEventListener('click', () => {
            ...
            setTimeout(() => { 
                ...
                openBtn.classList.add('show'); // Küçültülmüş butonu çıkar
            }, 300);
        });
        ...
        openBtn.addEventListener('click', () => {
            ...
            wrapBox.style.display = 'flex'; // Önce flex yapıp DOM'a al
            setTimeout(() => {
                wrapBox.classList.remove('closed'); // Animasyonu tetikle
                inputField.focus(); // Tıklayınca yazma alanına odaklan
                feedArea.scrollTop = feedArea.scrollHeight; // En alta kaydır
            }, 10);
        });
